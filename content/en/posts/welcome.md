---
title: "Welcome to WaqtSalat Blog"
date: 2026-03-10
draft: false
...
- **Accurate Prayer Times**: Uses the official Habous Ministry method for calculating Fajr and Isha angles
- **Offline-First**: Works completely without internet connection after first load
- **Zero Tracking**: No ads, no analytics, no data collection
- **Open Source**: Fully transparent code available for community review
- **Multilingual**: Available in Arabic, French, and English
- **Progressive Web App**: Install on your home screen for quick access

## Why Offline-First Matters in Morocco
...
Different Muslim countries and regions use varying calculation methods. The Habous method has been officially adopted in Morocco to ensure consistency across the kingdom's mosques and prayer notification systems.
...
- **Community Trust**: Independent verification of accuracy
- **Bug Fixes**: Rapid community-driven improvements
- **Transparency**: No hidden algorithms or black-box calculations

## What's Coming Next

We're actively working on:
- Qibla direction calculator
- Mosque location finder
- Community event notifications
- Multi-platform support (iOS, Android improvements)
...
Yes, WaqtSalat is completely free and will always remain free. We're a community project, not a commercial product.

### Does it work without internet?

Yes! After the initial data download, WaqtSalat works entirely offline. This is essential for areas with unreliable internet coverage.

### How are prayer times calculated?

We use the official Habous Ministry method for Morocco, which sets Fajr at 19° and Isha at 17° angles.

### Is my data collected?

No. WaqtSalat has zero tracking — no analytics, no ads, and no data collection. Your privacy is respected.

### Can I contribute?

Yes! WaqtSalat is open source. You can report bugs, suggest features, or contribute code on our GitHub repository.

---

## References

- [Habous Ministry Official Prayer Times](https://www.habous.gov.ma/) - Official source for Moroccan prayer time calculations
- [Hugo Documentation](https://gohugo.io/) - The static site generator powering this blog
- [Progressive Web App Guidelines](https://web.dev/progressive-web-apps/) - PWA standards and best practices
- [Muslim Prayer Time Calculations](https://en.wikipedia.org/wiki/Prayer_times_in_Islam) - Overview of global prayer calculation methods
